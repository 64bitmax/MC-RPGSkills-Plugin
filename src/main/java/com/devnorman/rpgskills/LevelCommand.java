    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if(sender instanceof Player) {
            ...
            try {
                ...
                if(!result.next()) {
                    Statement createPlayerStatement = RPGSkills.dbConnector.getConnection().createStatement();
                    createPlayerStatement.execute("INSERT INTO rpgskills_player_data(player_name) VALUES('" + player.getName() + "')");
                    createPlayerStatement.close();
                }
